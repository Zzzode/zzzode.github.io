...
- **Role:** it is the mandatory step 6 ("Humanize the prose") of the `distill` skill (`.claude/skills/distill/SKILL.md`). Every distilled MDX article passes through these rules after the draft is written and before `npm run check` / `npm run build`.
