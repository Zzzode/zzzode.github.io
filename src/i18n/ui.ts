...
const dict = {
  zh: {
    ...
    'home.archive': '完整档案',
    'home.topics': '按主题读',
    'home.topics.sub': '21 篇文章沿四条主线展开',
    'home.band.words': '篇深度文章',
    'home.band.lines': '条主线',
    'home.band.sources': '全部基于公开一手来源',
    'home.band.zerojs': '框架页零 JavaScript',
  ...
  en: {
    ...
    'home.recent': 'Latest long-form',
    'home.archive': 'Full archive',
    'home.topics': 'Read by topic',
    'home.topics.sub': '21 articles along four threads',
    'home.band.words': 'long-form articles',
    'home.band.lines': 'threads',
    'home.band.sources': 'all built on public primary sources',
    'home.band.zerojs': 'zero JavaScript on framework pages',
