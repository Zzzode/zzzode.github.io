...
const dict = {
  zh: {
    ...
    'home.eyebrow': '研究 · 工程',
    'home.lead': '在这里记录研究、工程与思考。这里有我的论文、演讲、教学和文章。',
    'home.viewPublications': '查看论文',
    'home.viewCv': '阅读 CV',
  ...
  en: {
    ...
    'home.eyebrow': 'RESEARCH · ENGINEERING',
    'home.lead':
      'Notes on research, engineering and ideas — publications, talks, teaching and writing.',
    'home.viewPublications': 'View publications',
    'home.viewCv': 'View CV',
